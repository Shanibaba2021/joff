      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
            <form id="form" role="form text-left" method="post" action="<?php echo base_url('index.php/Login/check'); ?>" name="myForm" onsubmit="return validateForm()">
                <div class="mb-3">
    ...
    $('#submit').click(function(event){
      ...
      $.ajax({
        ...
        success:function(data){
          ...
          if(data.status == '1'){
            window.location.href = "<?php echo base_url(); ?>index.php/Login/dash";
          }
          else{
